...
class storage_factory:
    ...
    @staticmethod
    def create_turn(
        stor: uuid.UUID, amount: int, nom: nomenclature_model, ran: range_model
    ):
    ...
    @staticmethod
    def create_row(
        target_storage: storage_model, operation: storage_journal_transaction
    ):
    ...
    def create_transaction(
        type_arg: bool, nomenclature: nomenclature_model, how_many: int, date: datetime
    ):
